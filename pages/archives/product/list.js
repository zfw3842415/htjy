...
Page({
    ...
    App._requestApi(_this, App.globalData.config.apiListUrl, {
      ...
      if (isPage == true) {
        ...
        _this.setData({
          ...
          isLoading: false,
          typeid:channelList[_this.data.index].id
        });
  ...
  onSwitchTab: function (e) {
    ...
    _this.data.index = e.currentTarget.dataset.index;
    if(current_channel == 2){
      // 第一步：切换当前的分类id
      _this.setData({
        typeid:_this.data.channelList[_this.data.index].id,
        archivesList: {},
        page: 1,
        no_more: false,
        isLoading: true
